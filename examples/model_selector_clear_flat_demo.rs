...
struct ModelSelectorClearFlatDemo {
...
impl ModelSelectorClearFlatDemo {
    fn new(window: &mut Window, cx: &mut Context<Self>) -> Self {
        // Create sample models - 使用单一提供商强制平面模式
        let models = vec![
            ModelInfo {
                id: "gpt-4".to_string(),
        ...
        // Create model selector - 强制不分组以使用平面选项
        let model_selector = cx.new(|cx| {
            ModelSelector::new_with_models_and_direction(cx, models, DropdownDirection::Auto)
                ...
                .group_by_provider(false) // 强制使用平面选项
        });
        ...
        Self {
            ...
            clear_button,
            messages: vec![
                "Welcome to the Model Selector Clear Demo (Flat Mode)!".to_string(),
                "This demo uses flat options instead of grouped options.".to_string(),
...
impl Render for ModelSelectorClearFlatDemo {
                                ...
                                div()
                                    ...
                                    .child(
                                        div()
                                            ...
                                            .child("Model Selector Clear Demo (Flat Mode)")
                                    )
                            )
                            .child(
                                // Main content
                                                ...
                                                div()
                                                    ...
                                                    .child(
                                                        div()
                                                            .text_lg()
                                                            .text_color(rgb(0x1A1A1A))
                                                            .child("Model Selector (Flat Mode)")
                                                    )
                                                    .child(
                                                        div()
                                                            .text_sm()
                                                            .text_color(rgb(0x666666))
                                                            .child("Select a model from the dropdown (flat options)")
                                                    )
                                                    .child(
                                                        div()
                                                            .w_full()
                                                ...
                                                div()
                                                    ...
                                                    .child(
                                                        div()
                                                            ...
                                                            .child("💡 This demo uses flat options (no grouping) to test the clear functionality. You should see 'No model selected' as the first option in the dropdown.")
                                                    )
                                            )
                                    )
                                    .child(
            ...
            let _ = cx.open_window(
                WindowOptions {
                    ...
                    titlebar: Some(TitlebarOptions {
                        title: Some("Model Selector Clear Demo (Flat)".into()),
                    ...
                    app_id: Some("model_selector_clear_flat_demo".into()),
                    is_minimizable: true,
                    is_resizable: true,
                    window_decorations: Some(WindowDecorations::Server),
                    tabbing_identifier: None,
                },
                |window, cx| cx.new(|cx| ModelSelectorClearFlatDemo::new(window, cx)),
            );
        });
}
