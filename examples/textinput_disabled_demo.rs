    ...
    app.run(move |cx| {
        let window_options = WindowOptions {
            ...
            titlebar: Some(TitlebarOptions {
                title: Some("Fluix TextInput Disabled Demo".into()),
        ...
        cx.open_window(window_options, |window, cx| {
            cx.new(|cx| TextInputDisabledDemo::new(window, cx))
        }).unwrap();
    });
}

struct TextInputDisabledDemo {
    scroll_handle: ScrollHandle,
    disabled_input: Entity<TextInput>,
}

impl TextInputDisabledDemo {
...
impl Render for TextInputDisabledDemo {
