                        ...
                        div()
                            ...
                            .child(
                                div()
                                    ...
                                    .child("📝 TextArea Features (Scroll Down)")
                            )
                            .child(
                                div()
                                    .text_xs()
                                    .text_color(rgb(0x9A3412))
                                    .child("TextArea components are below. Scroll down to see:")
                            )
                            .child(
                                div()
                                    .text_xs()
                                    .text_color(rgb(0x9A3412))
                                    .child("✓ Mouse click positioning")
                            )
                            .child(
                                div()
                                    .text_xs()
                            ...
                            .child(
                                div()
                                    .text_xs()
                                    .text_color(rgb(0x9A3412))
                                    .child("✓ Cursor blinking animation")
                            )
                            .child(
                                div()
                                    .text_xs()
                                    .text_color(rgb(0x9A3412))
                                    .child("✓ Delete key support")
                            )
                    )
            )
            )
