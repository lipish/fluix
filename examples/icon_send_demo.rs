                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .child("Send icon with various backgrounds (square and rectangular)")
                    )
            )
            .child(
                div()
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .child("Code: .with_square_bg(color).rounded(px(8.))")
                    )
            )
            .child(
                div()
                        ...
                        div()
                            ...
                            .child(
                                Icon::new(IconName::Send)
                                    .medium()
                                    .color(rgb(0x10B981))
                                    .with_rect_bg(px(80.), px(40.), rgb(0xD1FAE5))
                                    .rounded(px(8.))
                            )
                            .child(
                                Icon::new(IconName::Send)
                                    .medium()
                                    .color(rgb(0xF59E0B))
                                    .with_rect_bg(px(80.), px(40.), rgb(0xFEF3C7))
                                    .rounded(px(8.))
                            )
                    )
                    .child(
                        div()
                            .text_xs()
                            .text_color(rgb(0x9CA3AF))
                            .child("Code: .with_rect_bg(px(80.), px(40.), color).rounded(px(8.))")
                    )
            )
            .child(
                div()
                    ...
                    .child(
                        div()
                            .text_xs()
                            .text_color(rgb(0x9CA3AF))
                            .child("Code: Icon::new(IconName::Send).large().color(color)")
                    )
            )
            .child(
                div()
                        ...
                        div()
                            ...
                            .child(
                                div()
                                    ...
                                    .child("• Icons can have square or rectangular backgrounds")
                            )
                            .child(
                                div()
                                    .text_sm()
                                    .text_color(rgb(0x15803D))
                                    .child("• Use .with_square_bg() for square backgrounds")
                            )
                            .child(
                                div()
                                    .text_sm()
                                    .text_color(rgb(0x15803D))
                                    .child("• Use .with_rect_bg() for rectangular backgrounds")
                            )
                            .child(
                                div()
                                    .text_sm()
                                    .text_color(rgb(0x15803D))
                                    .child("• Use .rounded() to add border radius")
                            )
                    )
            )
                    )
