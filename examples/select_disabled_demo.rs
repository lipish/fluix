    ...
    app.run(move |cx| {
        let window_options = WindowOptions {
            ...
            titlebar: Some(TitlebarOptions {
                title: Some("Fluix Select Disabled Demo".into()),
        ...
        cx.open_window(window_options, |window, cx| {
            cx.new(|cx| SelectDisabledDemo::new(window, cx))
        }).unwrap();
    });
}

struct SelectDisabledDemo {
    scroll_handle: ScrollHandle,
    select: Entity<Select>,
}

impl SelectDisabledDemo {
...
impl Render for SelectDisabledDemo {
