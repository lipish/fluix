    ...
    app.run(move |cx| {
        let window_options = WindowOptions {
            ...
            titlebar: Some(TitlebarOptions {
                title: Some("Fluix Combobox Disabled Demo".into()),
        ...
        cx.open_window(window_options, |window, cx| {
            cx.new(|cx| ComboboxDisabledDemo::new(window, cx))
        }).unwrap();
    });
}

struct ComboboxDisabledDemo {
    scroll_handle: ScrollHandle,
    combobox: Entity<Combobox>,
}

impl ComboboxDisabledDemo {
...
impl Render for ComboboxDisabledDemo {
