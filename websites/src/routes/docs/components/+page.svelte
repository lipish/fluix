			...
			{:else if selectedComponent === 'icon'}
				<section class="demo-section">
					...
					<div class="icon-grid">
						...
						<div class="icon-item"><X size={24} /><span>X</span></div>
						<div class="icon-item"><ChevronDown size={24} /><span>ChevronDown</span></div>
						<div class="icon-item"><Eye size={24} /><span>Eye</span></div>
						<div class="icon-item"><EyeOff size={24} /><span>EyeOff</span></div>
					</div>
				</section>
